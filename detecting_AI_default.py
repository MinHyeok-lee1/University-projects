...
while cap.isOpened:
    ...
    for contour in contours:
        ...
        if area > surface:
            ...
            cv2.putText(ROI, labels[idx], org=(10, 30), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=1.4, color=(255, 255, 255), thickness=2)
           
            if prediction[0][0] > prob:
                cv2.putText(ROI, str('Fire'), org=(10, 30), fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=1.4, color=(50, 20, 255), thickness=2)
