...
// 화면 구성을 상태 위젯. 애니메이션 효과를 위해 TickerProviderStateMixin를 가짐
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: Theme
            .of(context)
            .platform == TargetPlatform.iOS ? 0.0 : 0.6,
      ),
      body: Container(
        child: Column(
          children: <Widget>[
            ...
            Flexible(
              ...
              child: ListView.builder(
                  ...
                  // 리스트뷰의 스크롤 방향으로 반대로 변경. 최신 메시지가 하단에 추가됨
                  reverse: true,
          ...
          children: <Widget>[
            ...
            Flexible(
              child: TextField(
                ...
                // 키보드상에서 확인을 누를 경우, 입력값이 있을 때만 _handleSubmitted 호출
                onSubmitted: _isComposing ? _handleSubmitted : null,
                // 텍스트 필드에 힌트 텍스트 추가
                decoration: InputDecoration.collapsed(
                    hintText: "Sned a Message"),
              ),
            ),
            // 전송 버튼
            Container(
