...
// 몰입 모드
        ...
        Cardd = (TextView) findViewById(R.id.Cardd);

        ka = (ImageView) findViewById(R.id.kkp);
        ke = (ImageView) findViewById(R.id.kke);
        kk = (ImageView) findViewById(R.id.kkk);
        kn = (ImageView) findViewById(R.id.kkn);
