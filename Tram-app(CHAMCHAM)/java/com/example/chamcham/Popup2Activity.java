...
public class Popup2Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 레이아웃 설정
        setContentView(R.layout.activity2_popup);
...
//        getWindow().getAttributes().height = height;
        ...
        final Intent intent = new Intent(this, Popup2Activity_1.class);
        final Intent intent1 = new Intent(this, MainActivity_1.class);

        btn1 = (TextView) findViewById(R.id.btnyes01);
        btn2 = (TextView) findViewById(R.id.btnno01);
        ...
        color = (TextView) findViewById(R.id.atd2ContentTv);
